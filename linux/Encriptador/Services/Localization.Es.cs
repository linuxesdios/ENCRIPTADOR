...
public static partial class Loc
{
    private static readonly Dictionary<string, string> Es = new()
    {
        ...
        ["common.estado.procesandoArchivo"] = "Procesando archivo {0} de {1}...",
        ...
        ["explorer.estado.errorAlAbrir"] = "   (no se pudo abrir: {0})",
        ["explorer.error.noSePudoAbrir"] = "No se pudo abrir el archivo: {0}",

        // ===== about (AboutWindow) =====
        ["about.desarrollador"] = "Desarrollador de la aplicación",
        ["about.tagline"] = "Cifrado y descifrado de archivos con AES-256-GCM",
        ["about.version"] = "Versión 1.0 · Avalonia UI",
        ["about.cerrar"] = "Cerrar",
    };
}
